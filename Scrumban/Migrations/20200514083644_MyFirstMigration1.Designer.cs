...
namespace Scrumban.Migrations
{
    ...
    [Migration("20200514083644_MyFirstMigration1")]
            ...
            modelBuilder.Entity("Scrumban.DataAccessLayer.Models.TaskDAL", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Name = "Task1", PriorityId = 1, StartDate = new DateTime(2020, 5, 14, 11, 36, 42, 556, DateTimeKind.Local), TaskStateId = 1 },
                        new { Id = 2, Name = "Task2", PriorityId = 1, StartDate = new DateTime(2020, 5, 14, 11, 36, 42, 561, DateTimeKind.Local), TaskStateId = 1 },
                        new { Id = 3, Name = "Task3", PriorityId = 1, StartDate = new DateTime(2020, 5, 14, 11, 36, 42, 561, DateTimeKind.Local), TaskStateId = 1 }
                    );
                });
