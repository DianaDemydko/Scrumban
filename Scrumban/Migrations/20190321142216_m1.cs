...
namespace Scrumban.Migrations
{
    public partial class m1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "Id", "Description", "Name", "PriorityId", "ProgrammerId", "StoryId", "TaskStateId" },
                values: new object[] { 1, null, "Task1", 2, null, null, 1 });

            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "Id", "Description", "Name", "PriorityId", "ProgrammerId", "StoryId", "TaskStateId" },
                values: new object[] { 2, null, "Task2", 2, null, null, 1 });

            migrationBuilder.InsertData(
                table: "Tasks",
                columns: new[] { "Id", "Description", "Name", "PriorityId", "ProgrammerId", "StoryId", "TaskStateId" },
                values: new object[] { 3, null, "Task3", 2, null, null, 1 });
